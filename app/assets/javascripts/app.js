...
var App = function () {
  ...
  var uiInit = function () {
    ...
    $('.input-typeahead').typeahead({
      ...
      source: function(query, callback) {
        elementNames = getListElement();
        callback(elementNames); // call callback here
      }
    });
  
    $('.button-search').click(function (e) {
      console.log(elementIds[$('#search-data').val()]);
      scrollToElm(document.getElementById('participant-timeline'), document.getElementById(elementIds[$('#search-data').val()]), 1);
    })
  
    $('.admin-button-search').click(function (e) {
      console.log(elementIds[$('#search-data').val()]);
      scrollToElm(document.getElementById('admin-timeline'), document.getElementById(elementIds[$('#search-data').val()]), 1);
    })
    ...
    function getListElement() {
      ...
      for(const i of $(".timeline-content .title")){
        ...
        data = i.getAttribute('data');
        title = i.innerText;
        listElement.push(title);
        elementIds[title] = data;
      }
      return listElement
    }
  ...
  var dtIntegration = function () {
    $.extend(true, $.fn.dataTable.defaults, {
      "sDom": "<'row'<'col-sm-6 col-xs-5'l><'col-sm-6 col-xs-7'f>r>t<'row'<'col-sm-5 hidden-xs'i><'col-sm-7 col-xs-12 clearfix'polls>>",
